          ...
          <div className="overflow-x-auto rounded-xl">
            <table className="w-full text-sm text-left">
              <thead className="text-xs uppercase border-b border-slate-200">
                <tr>
                  <th className="px-6 py-4 font-bold min-w-[200px] sticky left-0 top-24 z-30 bg-slate-50 text-slate-700 shadow-[2px_0_5px_-2px_rgba(0,0,0,0.05)] border-b border-slate-200">
                    Employee
                  </th>
                  {weekDates.map((d) => {
                    ...
                    return (
                        <th key={d.dateStr} className={`px-4 py-4 min-w-[140px] text-center sticky top-24 z-20 ${headerClass}`}>
